...
import { changeChartRange , changeChartCellData , renderChart, checkCurrentBoxChange } from '../utils/chartUtil'
 ...
 */
function createChart(render, chartData, chart_id, chartType = 'echarts|line|default', rangeArray, rangeTxt) {
    ...
    chartOptions.chartAllType = chartType
...
function resizeChart(chart_id) {
    ...
    if (chartPro == "echarts") {
        if ( echarts.getInstanceById($("#" + chart_id).attr("_echarts_instance_"))) {
